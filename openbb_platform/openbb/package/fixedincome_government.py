...
from openbb_core.app.provider_interface import (
    OBBject_TipsYields,
    OBBject_TreasuryAuctions,
    OBBject_TreasuryPrices,
...
class ROUTER_fixedincome_government(Container):
    ...
    def treasury_auctions(
        self,
        security_type: Annotated[Optional[Literal['bill', 'note', 'bond', 'cmb', 'tips', 'frn']], OpenBBField(description="Used to only return securities of a particular type.\nChoices for government_us: 'bill', 'note', 'bond', 'cmb', 'tips', 'frn'")] = None,
        cusip: Annotated[Optional[str], OpenBBField(description='Filter securities by CUSIP.')] = None,
        page_size: Annotated[Optional[int], OpenBBField(description='Maximum number of results to return; you must also include pagenum when using pagesize.')] = None,
        page_num: Annotated[Optional[int], OpenBBField(description='The first page number to display results for; used in combination with page size.')] = None,
        start_date: Annotated[Union[datetime.date, None, str], OpenBBField(description='Start date of the data, in YYYY-MM-DD format. The default is 90 days ago.')] = None,
        end_date: Annotated[Union[datetime.date, None, str], OpenBBField(description='End date of the data, in YYYY-MM-DD format. The default is today.')] = None,
        provider: Annotated[Optional[Literal['government_us']], OpenBBField(description='The provider to use, by default None. If None, the priority list configured in the settings is used. Default priority: government_us.')] = None,
        **kwargs
    ) -> OBBject:
        ...
        use_cache : Optional[bool]
            Whether or not to use cache. If True, cache will store for two days. (provider: government_us)
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                extra_params=kwargs,
                info={'security_type': {'government_us': {'multiple_items_allowed': False, 'choices': ['bill', 'note', 'bond', 'cmb', 'tips', 'frn']}}},
            )
        )
    ...
    def treasury_prices(
        self,
        date: Annotated[Union[datetime.date, None, str], OpenBBField(description='A specific date to get data for. Defaults to the last business day.')] = None,
        provider: Annotated[Optional[Literal['government_us']], OpenBBField(description='The provider to use, by default None. If None, the priority list configured in the settings is used. Default priority: government_us.')] = None,
        **kwargs
    ) -> OBBject:
    ...
    def yield_curve(
        self,
        date: Annotated[Union[str, datetime.date, None, list[Union[str, datetime.date, None]]], OpenBBField(description='A specific date to get data for. By default is the current data. Multiple comma separated items allowed for provider(s): ecb, econdb, federal_reserve, fmp, fred.')] = None,
        provider: Annotated[Optional[Literal['ecb', 'econdb', 'federal_reserve', 'fmp', 'fred']], OpenBBField(description='The provider to use, by default None. If None, the priority list configured in the settings is used. Default priority: ecb, econdb, federal_reserve, fmp, fred.')] = None,
        **kwargs
    ) -> OBBject:
