...
class ROUTER_technical(Container):
    ...
    def adx(
        ...
        chart: Annotated[bool, OpenBBField(description="Whether to create a chart or not, by default False.")] = False,
        **kwargs: Any
    ) -> OBBject:
    ...
    def atr(
        ...
        mamode: Annotated[Literal["rma", "ema", "sma", "wma"], OpenBBField(description="")] = "rma",
    ...
    def bbands(
        ...
        mamode: Annotated[Literal["sma", "ema", "wma", "rma"], OpenBBField(description="")] = "sma",
        offset: Annotated[int, OpenBBField(description="")] = 0,
        **kwargs: Any
    ) -> OBBject:
    ...
    def cones(
        ...
        model: Annotated[Literal["std", "parkinson", "garman_klass", "hodges_tompkins", "rogers_satchell", "yang_zhang"], OpenBBField(description="")] = "std",
    ...
    def fib(
        ...
        data: Annotated[Union[list, dict, DataFrame, list["DataFrame"], Series, list["Series"], ndarray, Data, list[Data]], OpenBBField(description="")],
        index: Annotated[str, OpenBBField(description="")] = "date",
        close_column: Annotated[Literal["close", "adj_close"], OpenBBField(description="")] = "close",
    ...
    def kc(
        ...
        mamode: Annotated[Literal["ema", "sma", "wma", "hma", "zlma"], OpenBBField(description="")] = "ema",
    ...
    def relative_rotation(
        ...
        study: Annotated[Literal["price", "volume", "volatility"], OpenBBField(description="")] = "price",
        ...
        chart_params: Annotated[Optional[dict[str, Any]], OpenBBField(description="")] = None,
        chart: Annotated[bool, OpenBBField(description="Whether to create a chart or not, by default False.")] = False,
        **kwargs: Any
    ) -> OBBject:
