...
class ROUTER_currency(Container):
    ...
    def snapshots(
        ...
        counter_currencies: Annotated[Union[str, list[str], None], OpenBBField(description="An optional list of counter currency symbols to filter for. None returns all.")] = None,
